...
__all__ = [
    'SVP_11', 'SPVPRI_ALERT', 'SBOPause', 'DISPID_SRCEInterference',
    'SpeechVoiceSkipTypeSentence', 'SRCS_Enabled', 'ISpLexicon',
    'DISPID_SPRulesItem', 'SPPS_Function',
    ...
    'SAFTADPCM_11kHzStereo', 'SPVPRI_NORMAL', 'ISequentialStream',
    ...
    'SpeechRegistryLocalMachineRoot', 'SVPOver',
    'SpeechDisplayAttributes', 'DISPID_SRRSetTextFeedback',
    'SpeechWordType', 'DISPID_SPPId', 'ISpSerializeState',
    'SREPrivate', 'DISPID_SLPsCount', 'SPRECORESULTTIMES',
    'SpeechTokenContext', 'SPAR_High', 'DISPID_SAFType',
    'DISPID_SPARecoResult', 'DISPID_SDKGetStringValue', 'SGSDisabled',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SVSLastStreamNumberQueued',
    'SREAllEvents', 'SGSExclusive', 'DISPID_SVEEnginePrivate',
    'SpeechAudioVolume', 'DISPID_SRGSetTextSelection',
    'SAFT22kHz16BitMono', 'DISPID_SLWType', 'SpeechVisemeType',
    'ISpEventSource', 'DISPID_SRRecognizer', 'SSTTDictation',
    'SVSFNLPSpeakPunc', 'SPSSuppressWord', 'eLEXTYPE_PRIVATE20',
    'DISPID_SpeechWaveFormatEx', 'ISpeechResourceLoader',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SLWsCount',
    'DISPID_SLPLangId', 'DISPID_SLPPhoneIds', 'SVP_12',
    'ISpPhoneticAlphabetConverter', 'DISPID_SGRsCommitAndSave',
    'DISPID_SGRInitialState', 'ISpRecoCategory', 'SVSFIsXML',
    'SAFT16kHz16BitMono', 'eLEXTYPE_PRIVATE16',
    'DISPID_SPRFirstElement', 'IEnumString', 'DISPID_SGRAddResource',
    'DISPID_SRRTLength', 'DISPID_SRCreateRecoContext', 'ISpEventSink',
    'SAFTCCITT_ALaw_11kHzStereo', 'eLEXTYPE_PRIVATE11',
    'SVSFPersistXML', 'SAFT8kHz16BitMono',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SRCEventInterests',
    'ISpGrammarBuilder', 'DISPID_SRRTStreamTime',
    'SpeechGrammarState', 'DISPID_SPPValue', 'DISPID_SVIsUISupported',
    'ISpeechObjectToken', 'SpeechGrammarRuleStateTransitionType',
    'SSTTTextBuffer', 'DISPID_SpeechPhraseAlternates', 'SPSHT_EMAIL',
    'DISPID_SPRuleConfidence', 'SPEI_END_INPUT_STREAM',
    'IEnumSpObjectTokens', 'SPEI_RESERVED1', 'SP_VISEME_2',
    'SPSModifier', 'DISPID_SPEActualConfidence',
    'ISpeechPhraseElement', 'DISPID_SRGetRecognizers',
    'SAFTGSM610_8kHzMono', 'STCInprocServer',
    'DISPID_SRSetPropertyString', 'SREPropertyNumChange',
    'SpMMAudioIn', 'SRAExport', 'DISPID_SRDisplayUI', 'SSTTWildcard',
    'SpeechRegistryUserRoot', 'DISPID_SPEDisplayAttributes',
    'DISPID_SLGetPronunciations', 'DISPID_SDKSetStringValue',
    'SAFT12kHz8BitStereo', 'SpeechTokenShellFolder', 'SVF_None',
    'ISpeechMemoryStream', 'SVSFIsFilename', 'SPXRO_SML',
    'SpeechLoadOption', 'SpInprocRecognizer', 'DISPID_SPEsCount',
    'DISPID_SPRText', 'DISPID_SGRSTPropertyValue', 'DISPID_SRGCommit',
    'ISpeechRecoResultTimes', 'ISpeechPhoneConverter',
    'eLEXTYPE_PRIVATE5', 'SVESentenceBoundary',
    'DISPID_SRCCreateGrammar', 'DISPID_SPACommit', 'SRTStandard',
    'SAFT8kHz8BitMono', 'SpUnCompressedLexicon',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SPEAudioTimeOffset',
    'SREStreamStart', 'SpeechDiscardType', 'DISPID_SRRPhraseInfo',
    'ISpeechGrammarRuleStateTransitions', 'SVP_9',
    'DISPID_SpeechRecoResult2', 'SPPS_RESERVED4',
    'DISPID_SVGetAudioInputs', 'SpeechMicTraining',
    'eLEXTYPE_RESERVED10', 'eLEXTYPE_PRIVATE6', 'SDTProperty',
    'SPAS_PAUSE', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SBSWrite', 'DISPID_SPPChildren', 'eLEXTYPE_PRIVATE2',
    'DISPID_SRCResume', 'SVF_Stressed', 'ISpeechRecoContext',
    'SINoSignal', 'SVP_6', 'SGDisplay', 'DISPID_SWFEFormatTag',
    'ISpPhoneConverter', 'DISPID_SPILanguageId', 'SpWaveFormatEx',
    'SpeechWordPronounceable', 'SAFT12kHz8BitMono',
    'ISpeechLexiconWords', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SVPAlert', 'SpStreamFormatConverter', 'DISPID_SLWWord',
    'SpeechCategoryAudioOut', 'SAFT12kHz16BitMono',
    'SpeechTokenKeyFiles', 'SPAO_RETAIN_AUDIO',
    'SpPhoneticAlphabetConverter', 'SRSInactiveWithPurge',
    'SPRST_INACTIVE', 'DISPID_SPAPhraseInfo', 'eLEXTYPE_PRIVATE14',
    'SPAS_STOP', 'Speech_Max_Pron_Length', 'SAFTCCITT_ALaw_11kHzMono',
    'SVSFParseSsml', 'SPEI_UNDEFINED', 'SAFT48kHz8BitStereo',
    'eLEXTYPE_RESERVED4', 'DISPID_SRCEStartStream',
    'SpeechGrammarTagDictation', 'DISPID_SpeechGrammarRule',
    'SpeechGrammarTagWildcard', 'SPPS_RESERVED2',
    'DISPID_SRGCmdLoadFromFile', 'SPFM_NUM_MODES', 'DISPID_SBSSeek',
    'eWORDTYPE_DELETED', 'SpeechPropertyHighConfidenceThreshold',
    'SPPS_Noncontent', 'DISPID_SpeechGrammarRules', 'SPSFunction',
    'DISPID_SGRsCommit', 'SP_VISEME_1', 'ISpeechDataKey',
    'DISPID_SPPs_NewEnum', 'DISPID_SGRAttributes',
    'DISPID_SpeechDataKey', 'DISPID_SpeechMemoryStream',
    'DISPID_SLWsItem', 'DISPID_SAVolume', 'DISPID_SGRSRule',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPCT_SUB_COMMAND',
    'SVEEndInputStream', 'SpeechPropertyResourceUsage', 'SITooFast',
    'DISPID_SRRSpeakAudio', 'SpeechRuleAttributes', 'SVP_13',
    'DISPID_SOTId', 'DISPID_SPCIdToPhone', 'SINoise',
    'DISPID_SpeechRecoContext', 'SPEI_MIN_SR', 'ISpObjectWithToken',
    'SPLO_STATIC', 'SPCS_ENABLED', 'DISPID_SPRuleFirstElement',
    ...
    'DISPID_SRGDictationLoad', 'DISPID_SMSALineId', 'SP_VISEME_20',
    'ISpNotifySink', 'SpShortcut', 'DISPID_SVPause',
    'ISpeechRecoResultDispatch', 'DISPIDSPTSI_SelectionLength',
    'Speech_StreamPos_Asap', 'STSF_AppData', 'DISPID_SOTsCount',
    'eLEXTYPE_LETTERTOSOUND', '_SPAUDIOSTATE', 'SECLowConfidence',
    'SVP_3', 'SSSPTRelativeToEnd', 'DISPID_SPERetainedSizeBytes',
    'ISpeechRecognizer', 'SpNotifyTranslator', 'SP_VISEME_18',
    'SAFTCCITT_uLaw_8kHzMono', 'SAFT32kHz16BitStereo',
    'SpeechPropertyComplexResponseSpeed', 'SAFT32kHz8BitMono',
    'SpeechRunState', 'DISPID_SRRRecoContext',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'ISpeechLexiconPronunciation', 'ISpeechPhraseReplacements',
    'DISPID_SDKCreateKey', 'DISPID_SGRSTs_NewEnum', 'SPEI_SOUND_END',
    'SP_VISEME_13', 'SPVISEMES', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SWFEExtraData', 'SPDATAKEYLOCATION', 'SDKLCurrentConfig',
    'SVP_0', 'DISPID_SGRsCount', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SpeechPhraseRule', 'SVP_14', 'SRTSMLTimeout',
    'SDTPronunciation', 'SREStreamEnd', 'DISPID_SMSAMMHandle',
    'SpeechAllElements', 'SAFT44kHz8BitMono', 'DISPID_SPEs_NewEnum',
    'SREPhraseStart', 'DISPID_SRIsShared', 'DISPID_SPAsItem',
    'SPDKL_LocalMachine', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SRCBookmark', 'DISPID_SRSAudioStatus', 'SPLO_DYNAMIC',
    'SREPropertyStringChange', 'SPDKL_DefaultLocation',
    'SGPronounciation', 'eLEXTYPE_PRIVATE3', 'SRATopLevel',
    'DISPID_SRRAudio', 'SRSActiveAlways', 'DISPID_SFSOpen',
    'DISPID_SPRsItem', 'eLEXTYPE_PRIVATE19', 'SPPHRASEPROPERTY',
    'ISpProperties', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SpeechPhraseInfo', 'SAFT22kHz16BitStereo',
    'DISPID_SRCPause', 'DISPID_SOTDataKey', 'SPSVerb',
    'DISPID_SRCESoundStart', 'DISPID_SpeechRecoContextEvents',
    'SRAORetainAudio', 'SDKLDefaultLocation', 'SPCS_DISABLED',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SRCVoicePurgeEvent',
    'SRESoundStart', 'SREInterference', 'SpCustomStream',
    'SAFTDefault', 'DISPID_SpeechXMLRecoResult', 'SP_VISEME_4',
    'SpSharedRecognizer', 'DISPID_SpeechVoiceStatus',
    'SPCATEGORYTYPE', 'SP_VISEME_17', 'SpeechFormatType', 'ISpStream',
    'DISPID_SRSClsidEngine', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SpeechLexiconWord', 'DISPID_SVSLastBookmarkId', 'SLTUser',
    'SGDSActiveWithAutoPause', 'SPEI_VOICE_CHANGE',
    'DISPID_SpeechObjectToken', 'SDTLexicalForm',
    'DISPID_SVAudioOutput', 'ISpShortcut', 'SASStop',
    'DISPID_SRAudioInput', 'DISPID_SGRSTsItem', 'SPSEMANTICERRORINFO',
    'SPCT_DICTATION', 'DISPID_SPEDisplayText', 'DISPID_SGRName',
    'SPPARTOFSPEECH', 'ISpeechRecoResult', 'DISPID_SLWs_NewEnum',
    ...
    'SPEI_SR_BOOKMARK', 'eLEXTYPE_PRIVATE12', 'SPRS_INACTIVE',
    'SVSFDefault', 'SDTRule', 'SWPUnknownWordUnpronounceable',
    'SPEI_RESERVED6', 'SpVoice', 'DISPID_SOTMatchesAttributes',
    ...
    'DISPID_SLWPronunciations', 'ISpVoice', 'DISPID_SVAlertBoundary',
    'SPXMLRESULTOPTIONS', 'SREAudioLevel',
    'DISPID_SRCCreateResultFromMemory', 'SPEI_REQUEST_UI',
    'DISPID_SWFEAvgBytesPerSec', 'SpeechRetainedAudioOptions',
    'SPEI_SR_AUDIO_LEVEL', 'eLEXTYPE_USER_SHORTCUT',
    'ISpeechTextSelectionInformation', 'DISPID_SOTCId', 'SGLexical',
    'SPAUDIOBUFFERINFO', 'ISpeechRecognizerStatus',
    'SPINTERFERENCE_NOSIGNAL', 'SAFT16kHz16BitStereo',
    'SPGRAMMARWORDTYPE', 'eLEXTYPE_PRIVATE7',
    'eLEXTYPE_VENDORLEXICON', 'SPINTERFERENCE_TOOSLOW',
    'IInternetSecurityMgrSite', 'ISpeechGrammarRuleState',
    'DISPID_SRCERequestUI', 'SPWORDTYPE',
    'SPINTERFERENCE_LATENCY_WARNING', 'SPWAVEFORMATTYPE',
    'SPSHT_OTHER', 'ISpeechPhraseInfoBuilder',
    'DISPID_SPISaveToMemory', '_RemotableHandle', 'SVEPrivate',
    'SPEI_MAX_TTS', 'SpObjectTokenCategory', 'SAFT8kHz8BitStereo',
    'ISpObjectToken', 'SP_VISEME_21', 'SPDKL_CurrentConfig',
    'DISPID_SVEVoiceChange', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SGRClear', 'SPADAPTATIONRELEVANCE', 'SPEI_ADAPTATION',
    'ISpRecognizer2', 'SGRSTTEpsilon', 'DISPID_SRRGetXMLResult',
    'DISPID_SpeechPhraseElements', 'SVEBookmark', 'SPPS_RESERVED3',
    'SECFIgnoreKanaType', 'ISpeechAudioBufferInfo', 'DISPID_SPEsItem',
    'DISPID_SpeechObjectTokens', 'DISPID_SOTGetStorageFileName',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SRCEAudioLevel',
    'DISPID_SRCEAdaptation', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SVSInputWordPosition', 'STSF_FlagCreate',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SADefaultFormat',
    'SPGS_EXCLUSIVE', 'DISPID_SRCRecognizer', 'ISpPhrase',
    'SPINTERFERENCE_TOOFAST', 'ISpeechPhraseAlternates', 'DISPIDSPRG',
    'SPSERIALIZEDRESULT', 'Speech_Max_Word_Length',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SPRuleName',
    'DISPID_SWFEBlockAlign', 'DISPIDSPTSI_ActiveOffset',
    'SDTAlternates', 'SAFT48kHz16BitMono',
    'DISPID_SVAudioOutputStream', 'SpCompressedLexicon',
    'SpeechAudioFormatType', 'ISpPhoneticAlphabetSelection',
    'SPPS_RESERVED1', 'DISPID_SVWaitUntilDone',
    'IInternetSecurityManager', 'ISpeechGrammarRules',
    'SPEI_SENTENCE_BOUNDARY', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SLPType', 'SpeechPartOfSpeech', 'SPEI_SOUND_START',
    'SAFT11kHz8BitMono', 'SpeechEngineProperties', 'SECFIgnoreCase',
    'DISPID_SVSyncronousSpeakTimeout', 'SAFT11kHz8BitStereo',
    'ISpeechWaveFormatEx', 'SpeechTokenKeyAttributes',
    'SpeechStreamFileMode', 'SVSFParseMask',
    'DISPID_SOTRemoveStorageFileName', 'SGLexicalNoSpecialChars',
    'SASClosed', 'DISPID_SPRDisplayAttributes', 'ISpRecognizer3',
    'SpeechAudioFormatGUIDWave', 'ISpeechAudioStatus',
    'SPTEXTSELECTIONINFO', 'SPPS_SuppressWord',
    'DISPID_SPERequiredConfidence', 'SVP_21', 'DISPID_SDKEnumValues',
    'DISPID_SPPsItem', 'DISPID_SpeechLexicon', 'SPEI_WORD_BOUNDARY',
    'SPAR_Unknown', 'SpeechCategoryAudioIn', 'DISPID_SGRSTNextState',
    'DISPID_SVSInputWordLength', 'SVSFVoiceMask',
    'DISPID_SLGetGenerationChange', 'DISPID_SABufferNotifySize',
    'SVEAllEvents', 'SAFT16kHz8BitMono', 'SVP_17',
    'DISPID_SpeechCustomStream', 'DISPID_SRRSaveToMemory',
    'SPPHRASEELEMENT', 'SAFTCCITT_ALaw_44kHzMono', 'SpMMAudioOut',
    'DISPID_SpeechObjectTokenCategory', 'SPAUDIOSTATUS',
    'eLEXTYPE_APP', 'SSSPTRelativeToStart', 'SPRULESTATE',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SOTsItem', 'SRADynamic',
    'SpeechAudioState', 'SPEVENTENUM', 'SECFNoSpecialChars',
    'DISPIDSPTSI', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SPPFirstElement', 'DISPID_SOTCategory',
    'DISPID_SASFreeBufferSpace', 'DISPID_SpeechPhraseProperties',
    'SITooLoud', 'SpeechCategoryRecoProfiles',
    ...
    'SPAS_CLOSED', 'SRCS_Disabled', 'SPEI_TTS_AUDIO_LEVEL',
    'ISpNotifySource', 'STCInprocHandler', 'ISpXMLRecoResult',
    'SPSLMA', 'SPFM_OPEN_READWRITE', 'DISPID_SVEWord',
    'eLEXTYPE_PRIVATE8', 'SDTDisplayText', 'ISpeechAudioFormat',
    'SPPS_Noun', 'SPCT_SUB_DICTATION', 'SREBookmark',
    'DISPID_SLGenerationId', 'DISPID_SPEPronunciation',
    'SSFMCreateForWrite', 'SPPS_LMA', 'eLEXTYPE_PRIVATE17',
    'DISPID_SPEEngineConfidence', 'ISpeechLexicon',
    'SDA_No_Trailing_Space', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SGDSActive', 'DISPID_SASetState', 'DISPID_SWFEBitsPerSample',
    'SPSHORTCUTPAIRLIST', 'DISPID_SDKGetlongValue', 'SPEI_VISEME',
    'SPRST_NUM_STATES', '_ISpeechVoiceEvents', 'SPEI_START_SR_STREAM',
    ...
    'DISPID_SPPsCount', 'DISPID_SpeechAudioStatus', 'DISPID_SGRsItem',
    'DISPID_SPEAudioSizeBytes', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SRAudioInputStream', 'DISPID_SpeechLexiconProns',
    'DISPID_SPRuleEngineConfidence', 'SpeechCategoryPhoneConverters',
    'SPWF_INPUT', 'SVSFlagsAsync', 'DISPID_SOTIsUISupported',
    'DISPID_SPIEngineId', 'SpMMAudioEnum', 'DISPID_SAFGuid',
    'SPBO_NONE', 'SPLOADOPTIONS', 'DISPIDSPTSI_SelectionOffset',
    'ISpeechPhraseRules', 'SPWORDPRONOUNCEABLE', 'ISpeechRecoResult2',
    'SSFMCreate', 'DISPID_SGRsFindRule', 'SPFM_OPEN_READONLY',
    'SpeechRecognitionType', 'SP_VISEME_19',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SRCESoundEnd',
    'SPPS_NotOverriden', 'DISPID_SPPEngineConfidence', 'SPRECOSTATE',
    'DISPID_SPEAudioSizeTime', 'tagSTATSTG', 'eLEXTYPE_PRIVATE1',
    'ISpeechAudio', 'ISpRecoContext', 'DISPID_SPRNumberOfElements',
    'DISPID_SRCRetainedAudio', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SWFEChannels', 'ISpeechXMLRecoResult',
    'DISPID_SDKDeleteKey', 'DISPID_SVResume',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SVVolume',
    ...
    'DISPID_SFSClose', 'SpeechPropertyNormalConfidenceThreshold',
    'SGRSTTTextBuffer', 'DISPID_SRCEEnginePrivate',
    'DISPID_SAFGetWaveFormatEx', 'LONG_PTR', 'SVP_1', 'SP_VISEME_9',
    'SRTExtendableParse', 'DISPID_SGRsDynamic', 'ISpMMSysAudio',
    'SPRECOGNIZERSTATUS', 'ISpeechFileStream', 'SVSFUnusedFlags',
    'SpeechEmulationCompareFlags', 'eWORDTYPE_ADDED',
    'DISPID_SOTCSetId', 'ISpeechBaseStream', 'SpeechAudioProperties',
    'SRERequestUI', 'DISPID_SGRsAdd', 'SDKLCurrentUser', 'SPAR_Low',
    'SpeechInterference', 'SPVOICESTATUS', 'SPFM_CREATE_ALWAYS',
    'SAFTExtendedAudioFormat', 'DISPID_SRCVoice',
    'DISPID_SPIAudioSizeTime', 'SPAS_RUN', 'ISpNotifyTranslator',
    'SVP_15', 'DISPID_SPIReplacements', 'ISpRecoContext2',
    'SPBOOKMARKOPTIONS', 'STCLocalServer', 'DISPID_SVSkip',
    'DISPID_SRGRules', 'SPEI_RESERVED2', 'DISPID_SGRSTPropertyId',
    'eLEXTYPE_RESERVED8', 'DISPID_SPIProperties', 'DISPID_SPIGetText',
    'DISPID_SRIsUISupported', 'DISPID_SVEStreamStart',
    'SAFT24kHz8BitMono', 'SPSHORTCUTPAIR',
    'DISPID_SpeechPhraseProperty',
    'DISPID_SRCAudioInInterferenceStatus', 'SpeechVoiceEvents',
    'STSF_LocalAppData', 'SVSFParseAutodetect', 'DISPID_SASState',
    'DISPID_SREmulateRecognition', 'STCAll', 'DISPID_SPRules_NewEnum',
    'eLEXTYPE_PRIVATE18', 'DISPID_SpeechVoice',
    'SpeechDataKeyLocation', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SpeechLexiconWords', 'DISPID_SOTDisplayUI',
    'DISPID_SBSRead', 'DISPID_SGRSAddRuleTransition',
    'SPSHT_NotOverriden', 'ISpeechPhraseProperties',
    'SAFT24kHz16BitMono', 'SVEPhoneme', 'ISpRecognizer',
    'SDKLLocalMachine', 'DISPID_SPIElements', 'SVEStartInputStream',
    'SpeechRecognizerState', 'DISPID_SRGIsPronounceable',
    'SAFTGSM610_44kHzMono', 'SAFTGSM610_22kHzMono',
    'SPXRO_Alternates_SML', 'SPEI_SR_PRIVATE', 'SVP_16',
    'SPBINARYGRAMMAR', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SRERecognition', 'SVP_8', 'SAFTCCITT_ALaw_8kHzStereo',
    'SRTEmulated', 'SPLEXICONTYPE', 'SP_VISEME_7',
    'ISpeechPhraseReplacement', 'DISPID_SRRTimes',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SRAInterpreter', 'SPSInterjection',
    'SPFILEMODE', 'SVP_18', 'SpeechRecoContextState', 'SPRST_ACTIVE',
    'DISPID_SRState', 'SPBO_TIME_UNITS', 'SPSUnknown',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPPS_Modifier',
    'DISPID_SRStatus', 'SVSFParseSapi', 'DISPID_SASNonBlockingIO',
    'SPEI_MAX_SR', 'DISPID_SOTCreateInstance', 'DISPID_SPRuleId',
    'SECFDefault', 'SpAudioFormat', 'DISPID_SVGetProfiles',
    'ISpDataKey', 'SPFM_CREATE', 'SVPNormal', 'DISPID_SLPsItem',
    'SP_VISEME_10', 'DISPID_SpeechFileStream', 'SVEVoiceChange',
    'SAFTNoAssignedFormat', 'SPEI_TTS_PRIVATE', 'DISPID_SPCPhoneToId',
    'DISPID_SOTSetId', 'DISPID_SpeechPhraseReplacements',
    'SP_VISEME_15', 'SpSharedRecoContext', 'DISPID_SGRSTPropertyName',
    'SRTReSent', 'eLEXTYPE_RESERVED6', 'SRTAutopause',
    'eLEXTYPE_RESERVED7', 'SpeechGrammarWordType', 'SITooQuiet',
    'SECHighConfidence', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRCEHypothesis', 'SpeechTokenValueCLSID',
    'SPCONTEXTSTATE', 'ISpeechVoice', 'SPEVENT', 'SRARoot',
    'DISPID_SRGDictationSetState', 'SPAUDIOSTATE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'ISpeechGrammarRule',
    'SpeechSpecialTransitionType', 'DISPID_SPRulesCount',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SLGetWords', 'SDTAll',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SREAdaptation',
    'DISPID_SPCLangId', 'SPWT_LEXICAL',
    'ISpeechGrammarRuleStateTransition', 'SpeechUserTraining',
    'SPEI_FALSE_RECOGNITION', 'SAFT11kHz16BitStereo',
    'SpMemoryStream', 'SPAUDIOOPTIONS', 'SAFTCCITT_uLaw_11kHzMono',
    'SPBO_PAUSE', 'SAFT44kHz16BitStereo', 'DISPID_SGRSTRule',
    'DISPID_SGRSTransitions', 'DISPID_SRGReset', 'ISpRecoGrammar',
    'SPEI_START_INPUT_STREAM', 'DISPID_SVGetVoices',
    'DISPID_SRGState', 'SP_VISEME_12', 'DISPID_SABIMinNotification',
    'SPEI_PHONEME', 'SAFT24kHz8BitStereo', 'SGRSTTWildcard',
    'SPWORDPRONUNCIATION', 'DISPID_SLPPartOfSpeech',
    'ISpResourceManager', 'SpPhraseInfoBuilder', 'ISpeechVoiceStatus',
    'DISPID_SRCEEndStream', 'SRSEDone', 'DISPID_SOTCGetDataKey',
    'SPINTERFERENCE_NOISE', 'SLODynamic', 'SRESoundEnd',
    'DISPID_SOTRemove', 'SWPUnknownWordPronounceable', 'SVEViseme',
    'DISPID_SVSPhonemeId', 'SINone', 'eLEXTYPE_RESERVED9',
    'SP_VISEME_6', 'DISPID_SVStatus', 'SpStream',
    'SAFTADPCM_8kHzMono', 'DISPID_SVEBookmark', 'DISPID_SPRs_NewEnum',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SAFSetWaveFormatEx',
    'SPEI_RESERVED5', 'ISpeechLexiconPronunciations',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SWPKnownWordPronounceable',
    'DISPID_SpeechPhraseRules', 'SPPHRASE', 'SAFT22kHz8BitMono',
    'SSFMOpenForRead', 'SVP_19', 'DISPID_SPPName',
    'SpeechPropertyResponseSpeed', 'DISPID_SPAsCount', 'SASRun',
    'SPEI_TTS_BOOKMARK', 'SPPROPERTYINFO',
    'Speech_StreamPos_RealTime', 'UINT_PTR', 'tagSPTEXTSELECTIONINFO',
    'SpObjectToken', 'DISPID_SVEViseme',
    'DISPID_SpeechPhraseAlternate', 'Speech_Default_Weight',
    'DISPID_SPIEnginePrivateData', 'SGRSTTWord', 'DISPID_SPRsCount',
    'DISPID_SpeechBaseStream', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SCSBaseStream',
    'DISPID_SRCRequestedUIType', 'SAFT16kHz8BitStereo',
    'DISPID_SpeechAudio', 'SAFTADPCM_22kHzMono', 'SPEI_END_SR_STREAM',
    'SPEI_MIN_TTS', 'SPSTREAMFORMATTYPE', 'SPEI_INTERFERENCE',
    ...
    'DISPID_SVEventInterests', 'SAFT44kHz8BitStereo', 'SDTAudio',
    'SpeechCategoryAppLexicons', 'eLEXTYPE_PRIVATE9', 'SVP_10',
    'SVP_20', 'SP_VISEME_0', 'ISpeechObjectTokens',
    'DISPID_SBSFormat', 'DISPID_SDKDeleteValue',
    'SAFTCCITT_uLaw_44kHzStereo', 'SVSFIsNotXML',
    'SAFTNonStandardFormat', 'SP_VISEME_14',
    'DISPID_SpeechAudioBufferInfo', 'SpeechVoicePriority',
    'SPEI_PHRASE_START', 'DISPID_SDKGetBinaryValue',
    'SSFMOpenReadWrite', 'SWTAdded', 'SPRULE',
    'SPWORDPRONUNCIATIONLIST', 'SVP_4', 'DISPID_SVDisplayUI',
    ...
    'DISPID_SGRSAddWordTransition', 'SVEAudioLevel',
    'DISPID_SLPs_NewEnum', 'SPWT_DISPLAY', 'SP_VISEME_3',
    'SAFT22kHz8BitStereo', 'DISPID_SOTs_NewEnum', 'SPCT_SLEEP',
    'SP_VISEME_8', 'DISPID_SPAs_NewEnum', 'SRAONone',
    'DISPID_SPIRule', 'SP_VISEME_11', 'DISPID_SGRSTWeight',
    'ISpRecoResult', 'DISPID_SPIGetDisplayAttributes', 'SVP_7',
    'SGDSActiveUserDelimited', 'DISPID_SRGetPropertyString',
    'DISPID_SVSVisemeId', 'SFTSREngine', 'SRAImport',
    'SAFT44kHz16BitMono', 'SPPHRASEREPLACEMENT',
    'DISPID_SRSetPropertyNumber', 'SPEI_PROPERTY_NUM_CHANGE',
    'SP_VISEME_16', 'SpeechTokenIdUserLexicon', 'SPPHRASERULE',
    'SPSNotOverriden', 'SPSMF_UPS', 'SPINTERFERENCE', 'SPWORD',
    'STCRemoteServer', 'DISPID_SGRId',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SLTApp',
    'ISpeechPhraseProperty', 'SAFTText', 'SPEI_RECO_STATE_CHANGE',
    'SpeechAddRemoveWord', 'DISPID_SVGetAudioOutputs',
    'SRSEIsSpeaking', 'SRSInactive', 'ISpRecoGrammar2',
    'SpeechPropertyLowConfidenceThreshold',
    'SpeechRecoProfileProperties',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SAFTADPCM_44kHzMono',
    'SAFT12kHz16BitStereo', 'DISPID_SOTCDefault',
    'ISpeechObjectTokenCategory', 'SAFTCCITT_uLaw_8kHzStereo',
    'SpeechDictationTopicSpelling', 'SAFTCCITT_ALaw_8kHzMono',
    'SPPS_Verb', 'SFTInput', 'DISPID_SPRuleChildren',
    'DISPID_SPRuleParent', 'DISPID_SpeechPhoneConverter',
    'SVSFNLPMask', 'SRSActive',
    ...
    'SPINTERFERENCE_TOOLOUD', 'SAFT11kHz16BitMono', 'DISPID_SAStatus',
    'ISpeechLexiconWord', 'SPVPRIORITY', 'SAFTCCITT_uLaw_11kHzStereo',
    'SPSMF_SAPI_PROPERTIES', 'SGRSTTDictation', 'ISpeechPhraseInfo',
    'DISPID_SPIRetainedSizeBytes', 'SAFT32kHz8BitStereo', 'SpLexicon',
    'DISPID_SWFESamplesPerSec', 'SAFTCCITT_ALaw_22kHzMono',
    'SAFT32kHz16BitMono', 'SPSHORTCUTTYPE', 'SAFTADPCM_22kHzStereo',
    'SpResourceManager', 'DISPID_SPPParent', 'SPPS_Unknown',
    'eLEXTYPE_PRIVATE4', 'SVEWordBoundary', 'SpNullPhoneConverter',
    'SLOStatic', 'SREHypothesis', 'SGSEnabled', 'SpeechTokenKeyUI',
    'SpeechRuleState', 'DISPID_SRGDictationUnload',
    'DISPID_SRGetPropertyNumber', 'SPGRAMMARSTATE',
    'SRERecoOtherContext', 'SPSERIALIZEDPHRASE',
    'DISPID_SVEStreamEnd', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SRGRecoContext', 'SAFT48kHz8BitMono', 'SPBO_AHEAD',
    'ISpeechCustomStream', 'ISpeechPhraseAlternate',
    'DISPID_SpeechRecoResult', 'SPWORDLIST', 'WAVEFORMATEX',
    'DISPID_SOTCEnumerateTokens', 'SPSEMANTICFORMAT',
    'SpInProcRecoContext', 'DISPID_SRProfile', 'SAFTADPCM_11kHzMono',
    'DISPID_SVVoice', 'SpFileStream', 'DISPID_SRCSetAdaptationData',
    'DISPID_SLWLangId', 'DISPID_SPPConfidence', 'DISPID_SDKOpenKey',
    'SVP_5', 'ISpAudio', 'SPSNoun', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SOTGetAttribute', 'DISPID_SOTGetDescription',
    'SpeechPropertyAdaptationOn', 'DISPID_SDKSetLongValue',
    'DISPID_SGRSTsCount', 'DISPID_SVSLastResult', 'SVF_Emphasis',
    'SVP_2', 'SPEVENTSOURCEINFO', 'SPGS_DISABLED',
    'ISpObjectTokenCategory', 'SAFT48kHz16BitStereo',
    'eLEXTYPE_PRIVATE15', 'SPRECOCONTEXTSTATUS', 'SPCT_COMMAND',
    'ISpeechMMSysAudio', 'DISPID_SASCurrentSeekPosition',
    'SPAR_Medium', 'DISPID_SVRate', 'DISPID_SRCERecognition',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SAEventHandle',
    'DISPID_SVEPhoneme', 'SPVPRI_OVER', 'DISPID_SRCEBookmark',
    'DISPID_SPANumberOfElementsInResult', 'SRADefaultToActive',
    'IStream', 'SAFT8kHz16BitStereo', 'SDA_Two_Trailing_Spaces',
    'SAFT24kHz16BitStereo', '__MIDL_IWinTypes_0009',
    'DISPID_SPIAudioSizeBytes', 'SpeechVoiceCategoryTTSRate',
    'SECNormalConfidence', 'SpeechCategoryRecognizers',
    'SAFTADPCM_8kHzStereo', 'SGRSTTRule', 'ISpStreamFormatConverter',
    'SAFTCCITT_uLaw_22kHzStereo', '_ISpeechRecoContextEvents',
    'ISpeechPhraseElements', 'DISPID_SpeechRecognizer',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SECFIgnoreWidth', 'DISPID_SRRAlternates', 'SPAO_NONE',
    'SPSHT_Unknown', 'DISPID_SRRTTickCount',
    'DISPID_SRSSupportedLanguages', 'SP_VISEME_5',
    'eLEXTYPE_PRIVATE13', 'DISPID_SABIBufferSize',
    'DISPID_SpeechVoiceEvent', 'DISPID_SGRAddState', 'DISPID_SVSpeak',
    'SVSFPurgeBeforeSpeak', 'SPEI_RECOGNITION', 'SpeechRecoEvents',
    'SPRS_ACTIVE', 'DISPID_SVSInputSentenceLength', 'SBONone',
    'DISPID_SRRAudioFormat', 'SASPause', 'DISPID_SGRSTType',
    'SpPhoneConverter', 'DISPID_SMSSetData', 'DISPID_SDKEnumKeys',
    'SpeechVoiceSpeakFlags', 'DISPID_SPIGrammarId', 'SDTReplacement',
    'SpeechBookmarkOptions', 'DISPID_SRCState', 'DISPID_SLPSymbolic',
    'SPEI_RESERVED3', 'SREStateChange', 'SpeechLexiconType',
    'SWTDeleted', 'SPRST_ACTIVE_ALWAYS', 'DISPID_SVSRunningState',
    'DISPID_SRCEFalseRecognition', 'DISPID_SRGId',
    'DISPID_SRGCmdSetRuleIdState', 'SGDSInactive'
]

_check_version('1.1.14', 1660478209.128425)
