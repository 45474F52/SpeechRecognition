...
class Engine:
    ...
    def __init_hwnd() -> None:
        ...
        if Engine.__console_hwnd == 0:
            Engine.__console_hwnd = win32gui.GetForegroundWindow()
    ...
    def hide_console(self) -> None:
        ...
        self.__set_window_state(Engine.__console_hwnd, WindowStates.HIDE)

    def show_console(self) -> None:
        """Заново отображает консоль приложения после скрытия"""
        self.__set_window_state(Engine.__console_hwnd, WindowStates.SHOW)
